...
class NeuralNetworkThreeInputConcatenationTests(BaseTest):
    ...
    def test_random_algorithm(self):
        ...
        # TODO: check if plans are without conflicts

    def test_neural_network2_algorithm_performance(self):
        teachers = Teacher.objects.all()
        rooms = Room.objects.all()
        fields = FieldOfStudy.objects.all()
        results = list()
        ...
        report = BasicAlgorithmReport(time_in_seconds, mean_value, "neural network three input - concatenation model",
    ...
    def run_algorithm(self, fields, teachers, rooms):
        ...
        for _ in range(self.tries):
            ...
            try:
                ...
                # TODO: check if plans are without conflicts - try to count them
                results.append(out)
